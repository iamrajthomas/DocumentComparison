<%@ Page Title="Aspose Document Comparision POC: Document Comparison using Aspose.Words Library for .NET Application" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DocumentComparison.Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<h1>My Documents</h1>--%>
    <p class="lead margin-top-10">View, Manage (Add/Remove) and Compare Microsoft Word Documents.</p>
    
    <hr />
    <p class="margin-top-10">This is a POC to compare the MS Word Documents and show the comparison.</p>
    <p class="margin-top-10">This validates the comparison of two document by making use of Aspose DLLs and checks for all possible discrepancies if any.</p>
    <hr />
